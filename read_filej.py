...
#				print(line2)
				...
				l.write('set fmri(evg'+str(i)+'.3) '+BMIintercept+'\n')
				m.write('set fmri(evg'+str(i)+'.4) '+BMIslope+'\n')
				n.write('set frmi(evg'+str(i)+'.5) '+interactionapp+'\n')
				o.write('set frmi(evg'+str(i)+'.5) '+interactionunapp+'\n')  
g.close()
h.close()
