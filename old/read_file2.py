...
ev_name=os.path.join(basedir,'EDxRate','unappEDxRate.txt')
...
#h=open('mean.txt','w')
j=open('unappEDxRate_cov.txt','w')
#k=open('BMIintercept_cov.txt','w')
#l=open('BMIslope_cov.txt','w')
m=open('interactionunappBMIslope_cov.txt', 'w')
i=0 
...
#			mean = line2[1]
#			mean = mean.strip('\n')
			unappEDxRate2 = line2[2]
			unappEDxRate = unappEDxRate2.strip('\n')
#			print(appEDxRate)
...
#			BMIslope = BMIslope.strip('\n')
			...
			print(name2+' has a combination score of '+unappEDxRate)
...
#				h.write('set fmri(evg'+str(i)+'.1) '+mean+'\n')  
				j.write('set fmri(evg'+str(i)+'.2) '+unappEDxRate+'\n')  
#				k.write('set fmri(evg'+str(i)+'.3) '+BMIintercept+'\n')
#				l.write('set fmri(evg'+str(i)+'.4) '+BMIslope+'\n')  
				m.write('set fmri(evg'+str(i)+'.5) '+interaction+'\n')
